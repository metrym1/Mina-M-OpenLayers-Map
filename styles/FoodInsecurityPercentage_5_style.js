...
var style_FoodInsecurityPercentage_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("DATA CSV MAP Updated_Food Insec");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("DATA CSV MAP Updated_Food Insec") !== null) {
        labelText = String(feature.get("DATA CSV MAP Updated_Food Insec"));
    }
